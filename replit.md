...
- **Dashboard** (`client/src/pages/dashboard.tsx`) - Protected page showing attestation receipts, repositories, API keys, GitHub connection, onboarding walkthrough
...
### Backend (Express)
- **Routes** (`server/routes.ts`) - API endpoints for attestations, repositories, API keys, public attestation API, GitHub OAuth/webhooks, MCP tools, analytics, badges, receipt export, OpenAPI spec
...
- `POST /api/github/webhook` - GitHub push event webhook listener
...
- Phase 1: Rate limiting, search/filtering, public lookup page
- Phase 2: SDK docs page, MCP Tool Server, OpenAPI spec for GPT Actions
- Phase 3: GitHub OAuth flow, webhook listener for push events
